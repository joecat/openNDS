...
install:
	...
	cp forward_authentication_service/binauth/check_reauth_interval.sh $(DESTDIR)/usr/lib/opennds/
	sed -i 's/#!\/bin\/sh/#!\/bin\/bash/' $(DESTDIR)/usr/lib/opennds/check_reauth_interval.sh
