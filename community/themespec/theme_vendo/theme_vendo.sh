...
#Copyright (C) Jose Catubigan Jr. 2023
...
# Define a common header html for every page served
	...
	echo "<!DOCTYPE html>
		...
		<link rel=\"shortcut icon\" href=\"$gatewaurl/images/splash.jpg\" type=\"image/x-icon\">
		<link rel=\"stylesheet\" type=\"text/css\" href=\"$gatewaurl/splash.css\">
...
footer() {
	...
	echo "
		...
		<div style=\"font-size:0.5em;\">
			<br>
			<img style=\"height:60px; width:60px; float:left;\" src=\"$gatewaurl/$imagepath\" alt=\"Splash Page: For access to the Internet.\">
